...
class ActivityTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activity_type" do
    assert_difference('ActivityType.count') do
      post activity_types_url, params: { activity_type: { deleted_at: @activity_type.deleted_at, image: @activity_type.image, name: @activity_type.name } }
    end
  ...
  test "should update activity_type" do
    patch activity_type_url(@activity_type), params: { activity_type: { deleted_at: @activity_type.deleted_at, image: @activity_type.image, name: @activity_type.name } }
